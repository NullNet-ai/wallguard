...
pub fn build_router(state: AppState) -> Router<AppState> {
    let protected = Router::new()
        ...
        .route("/api/v1/devices/:id/metrics",                       get(metrics::get_metrics))
        ...
        .route("/api/v1/devices/:id/tunnels/rdp",                   post(tunnels::open_rdp))
        .route("/api/v1/devices/:id/tunnels/ssh/:session_id",       get(ws::ssh))
        .route("/api/v1/devices/:id/tunnels/tty/:session_id",       get(ws::tty))
        .route("/api/v1/devices/:id/tunnels/rdp/:session_id",       get(ws::rdp))
