...
pub mod wall_guard_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn handle_connections_data(
            &mut self,
            request: impl tonic::IntoRequest<super::ConnectionsData>,
...
pub mod wall_guard_server {
    ...
    pub trait WallGuard: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn handle_connections_data(
            &self,
            request: tonic::Request<super::ConnectionsData>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/wallguard_service.WallGuard/HandleConnectionsData" => {
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = HandleConnectionsDataSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
